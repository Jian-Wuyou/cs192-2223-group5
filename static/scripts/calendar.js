                ...
                <div class="col-sm-6 col-12 d-flex pa-sm">
                    <div class="card border-0 mt-5 flex-fill d-none" id="event">
                        <div class="card-header py-3 text-center">
                            Add Event
                            <button type="button" class="btn-close hide btn-close-white">
...
fetch('calendar_script/calendar_sample_data1.json')
  ...
  .then(data => {
    // Access the field values of the JSON object
    var name = data.professor;
    var age = data.course;
    var email = data.date;
...
//}
    ...
    $(function(){
        function showEvent(eventDate){
            ...
            // parse and input hard coded event in a set date
            //fetch('lms/calendar_script/sample_data.json')
            ...
            if (storedEvents == null){
                ...
                if(eventsList.length>0){
                    let eventsLi ='';
                    eventsList.forEach(event =>  $('.events-today').html(eventsLi +=`<div class="alert alert-light alert-dismissible fade show" role="alert">
                    ${event.eventText}
